...
dataset_path = '/media/jcneves/DATASETS/NVIDIA_FakeFace/byimg_original/'
output_path = '/media/jcneves/DATASETS/NVIDIA_FakeFace/byimg_alignedlib_0.3/'
...
for idx, image_path in enumerate(dataset_files):
    ...
    if len(rects) > 0:  # check if exist some detection
        ...
        if pose:
            ...
            image_path_out = output_path + file
